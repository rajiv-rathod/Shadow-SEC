...
from backend.app.schemas.models import NewsArticle, Base
...
class NewsIngester:
    ...
    async def ingest_recent_news(self, hours: int = 24):
        ...
        try:
            ...
            for source_name, feed_url in self.news_sources.items():
                try:
                    articles = await self._fetch_news_from_source(source_name, feed_url, hours)
    ...
    async def _fetch_news_from_source(self, source_name: str, feed_url: str, hours: int) -> List[Dict[str, Any]]:
            ...
            for entry in feed.entries:
                try:
                    ...
                    if not article_data["content"] and article_data["url"]:
                        article_data["content"] = await self._extract_article_content(article_data["url"])
    ...
    async def _analyze_article_content(self, article_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"sentiment_score": 0.0, "relevance_score": 0.0, "mentioned_stocks": []}
    ...
    def _calculate_sentiment(self, text: str) -> float:
        ...
        try:
            ...
            positive_words = [
                "growth", "profit", "gain", "increase", "strong", "positive", 
                "success", "beat", "exceed", "bullish", "upgrade", "buy"
            ]
            
            negative_words = [
                "loss", "decline", "decrease", "weak", "negative", "fail",
                "miss", "bearish", "downgrade", "sell", "risk", "concern"
            ]
